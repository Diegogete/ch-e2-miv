...
function jogo() {
  ...
  var words = [ 'Influência da imprensa na arte ', 'Influência da imprensa na arte ', 'Influência da imprensa na arte ', ' Influência da internet na arte', ' Influência da internet na arte', ' Influência da internet na arte','Influência da fotografia na arte','Influência da fotografia na arte','Influência da fotografia na arte'];
  for ( var i=1; i<=9; i++ ) {
